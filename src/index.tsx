      ...
      <div>
       <h1>Certificate of Analysis Generator</h1>
        <p>
          ...
          <button onClick={this.generate}>Generate Certificate of Analysis</button>
        </p>
      </div>
    );
  }
...
export class DocumentCreator {
                ...
                children: [
                    ...
                    new TableCell({
                        ...
                        children: [
                            ...
                            ...this.createProductInfoRows().map(info => 
                                new Paragraph({
                                    children: [
            ...
            new TableRow({
                children: [
                    ...
                    new TableCell({
                        ...
                        children: [new Paragraph({ 
                            children: [new TextRun({ text: "SPECIFICATION", bold: true })]
                        })]
                    }),
                    new TableCell({
                        shading: {
  ...
  private createPhysicalControlRows(): TableRow[] {
    const physicalControls = [
        { test: "Appearance", spec: "White crystals or crystalline powder", result: "Conforms" },
        ...
        new TableRow({
            children: [
                new TableCell({
                    ...
                    children: [new Paragraph({ 
                        children: [new TextRun({ text: "PHYSICAL CONTROL", bold: true })]
                    })]
                })
            ]
        }),
        ...physicalControls.map(control => new TableRow({
            children: [
                new TableCell({
                    width: {
                        size: 30,
        ...
        new TableRow({
            children: [
                new TableCell({
                    ...
                    children: [new Paragraph({ 
                        children: [new TextRun({ text: "CHEMICAL CONTROL", bold: true })]
                    })]
                })
            ]
        }),
        ...chemicalControls.map(control => new TableRow({
            children: [
                new TableCell({
                    width: {
                        size: 30,
        ...
        new TableRow({
            children: [
                new TableCell({
                    ...
                    children: [new Paragraph({ 
                        children: [new TextRun({ text: "MICROBIOLOGICAL CONTROL", bold: true })]
                    })]
                })
            ]
        }),
        ...microControls.map(control => new TableRow({
            children: [
                new TableCell({
                    width: {
                        size: 30,
